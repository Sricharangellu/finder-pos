...
- Full backend suite: 399/400 passing before this batch of fixes (1 failure was
  ...
  worktrees per `WORK/LOCK.md`; killed and not yet re-verified in isolation).
...
- Full suite re-run after all fixes landed: pending — see follow-up note below.
